...
export function HabitDay({defaultCompleted = 0, amount = 0, date}: HabitDayProps) {
    ...
    const dayAndAmount = dayjs(date).format('DD/MM')
    ...
    return(
        <Popover.Root>
            <Popover.Trigger className={clsx("w-10 h-10 border-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-fundo", {
